...
namespace PixelCrushers.DialogueSystem
{
    ...
    public class StandardUIQuestLogWindow : QuestLogWindow
    {
        ...
        public bool selectFirstQuestOnOpen = true;
        ...
        public TextMeshProUGUI questHeadingTextTemplate;
        public TextMeshProUGUI questDescriptionTextTemplate;
        ...
        [Header("Other")]
        public TextMeshProUGUI NoQuestLabel;
        ...
        public override void OnQuestListUpdated()
        {
            ...
            if (quests.Length == 0 && showNoQuestsText)
            {
                NoQuestLabel.gameObject.SetActive(true);
                NoQuestLabel.text = noQuestsMessage;
            }
            else
            {
                NoQuestLabel.gameObject.SetActive(false);
            }
        ...
        public override void RepaintSelectedQuest(QuestInfo quest)
        {
            ...
            if (quest != null)
            {
                ...
                questHeadingTextTemplate.gameObject.SetActive(true);
                questHeadingTextTemplate.text = quest.Heading.text;

                questDescriptionTextTemplate.gameObject.SetActive(true);
                questDescriptionTextTemplate.text = quest.Description.text;
            ...
            {
                questHeadingTextTemplate.gameObject.SetActive(false);
                questDescriptionTextTemplate.gameObject.SetActive(false);
            }
        }
